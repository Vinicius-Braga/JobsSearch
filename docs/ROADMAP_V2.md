...
- [ ] **Limitação nova a resolver**: com 50 empresas, a busca ficou lenta — a coleta é sequencial (uma empresa por vez), levando ~1 minuto. Antes de aumentar a lista ainda mais, vale paralelizar a coleta por empresa (`GupyJobSource` já é só I/O de rede, um bom candidato pra `CompletableFuture`/virtual threads).
